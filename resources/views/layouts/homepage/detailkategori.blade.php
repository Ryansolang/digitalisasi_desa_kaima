     ...
     <div class="breadcumb-wrapper " data-bg-src="{{ url('assetsdepan/img/bc.jpg')}}">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Kategori {{ $datakategori->nama_kategori }}</h1>
                <div class="breadcumb-menu-wrap">
                    <ul class="breadcumb-menu">
                        <li><a href="#">Kategori</a></li>
                        <li>{{ $datakategori->nama_kategori }}</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="vs-blog blog-style1">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title h5"><a href="blog-details.html">{{$tampilartikel->judul_artikel}}</a></h3>
